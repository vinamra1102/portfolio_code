...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Arrow rather than a hoisted `function` declaration: TypeScript discards
    // the `canvas`/`gl` null-narrowing above inside hoisted declarations, since
    // they could in principle be called before it runs.
